                ...
                <div className="max-w-[450px] h-[600px]
                    mx-auto bg-black/75 text-white">
                        <div className="max-w-[320px] mx-auto py-16">
                            ...
                            {
                                error ? <p className="mt-5 font-bold text-white p-3 rounded-sm bg-red-700"> {error} </p> : null
                            }
                            <form onSubmit={handleSubmit} className="w-full flex flex-col py-4">
                                ...
                                <button className="bg-red-600 py-3 my-6 rounded font-bold hover:bg-red-700/50">Sing In</button>
                                <div className="flex justify-between items-center
                                    text-small text-gray-400">
                                    <p> <input type='checkbox' /> Remember Me</p>
                                    <p> Need Help </p>
                                </div>
                                <p className="py-4"> <span className="text-gray-500">New To Netflix</span> <Link to="/signup"> Sing Up</Link></p>
                            </form>
                        </div>
                </div>
            </div>
